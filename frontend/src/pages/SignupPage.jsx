      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>
            Start your financial journey with FinBud
          </p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="rounded-xl p-8 space-y-5 shadow-sm"
        ...
        >
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3" style={{ background: 'var(--card-bg)', color: 'var(--text-secondary)' }}>
                or
              </span>
            </div>
          </div>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl font-medium transition"
            style={{
              border: '1px solid var(--border-color)',
              color: 'var(--text-primary)',
